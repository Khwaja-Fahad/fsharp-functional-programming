...
function Main(){
  const _1=Doc.Element("div", [Attr.Create("class", "app")], [Doc.Element("div", [Attr.Create("class", "header")], [Doc.Element("div", [Attr.Create("class", "header-top")], [Doc.Element("span", [Attr.Create("class", "label-left")], [Doc.TextNode("VEL6D3")]), Doc.Element("span", [Attr.Create("class", "label-right")], [Doc.TextNode("Fahad Muhammad")])]), Doc.Element("div", [Attr.Create("class", "header-icon")], [Doc.TextNode("\ud83d\udcda")]), Doc.Element("h1", [], [Doc.TextNode("BookFinder")]), Doc.Element("p", [Attr.Create("class", "subtitle")], [Doc.TextNode("Find any book PDF instantly from 8 sources")]), Doc.Element("p", [Attr.Create("class", "author-credit")], [Doc.TextNode("by Fahad Muhammad")])]), Doc.Element("div", [Attr.Create("class", "search-card")], [Doc.Element("div", [Attr.Create("class", "search-row")], [Doc.Element("div", [Attr.Create("class", "input-wrap")], [Doc.Element("span", [Attr.Create("class", "input-icon")], [Doc.TextNode("\ud83d\udcd6")]), Doc.Input([Attr.Create("placeholder", "Enter book title..."), Attr.Create("class", "search-input")], titleVar())]), Doc.Element("div", [Attr.Create("class", "input-wrap")], [Doc.Element("span", [Attr.Create("class", "input-icon")], [Doc.TextNode("\u270d\ufe0f")]), Doc.Input([Attr.Create("placeholder", "Author name (optional)..."), Attr.Create("class", "search-input")], authorVar())])]), Doc.Element("button", [Attr.Create("class", "search-btn"), Attr.HandlerImpl("click", () =>() => doSearch())], [Doc.TextNode("\ud83d\udd0d  Find PDF")]), Doc.Element("p", [Attr.Create("class", "msg")], [Doc.TextView(msgVar().View)])]), Doc.BindView((loading) =>!loading?Doc.Element("div", [], []):Doc.Element("div", [Attr.Create("class", "loading-section")], [Doc.Element("div", [Attr.Create("class", "loading-spinner")], []), Doc.Element("p", [Attr.Create("class", "loading-text")], [Doc.TextNode("\ud83d\udd0d Searching across all sources...")]), Doc.Element("p", [Attr.Create("class", "loading-sub")], [Doc.TextNode("Opening best result automatically...")])]), loadingVar().View), Doc.Element("div", [Attr.Create("class", "popular-section")], [Doc.Element("p", [Attr.Create("class", "section-title")], [Doc.TextNode("\u26a1 Quick Search")]), Doc.Element("div", [Attr.Create("class", "popular-grid")], [Doc.Concat(map((_2) => {
    const title=_2[0];
    const author=_2[1];
    return Doc.Element("button", [Attr.Create("class", "popular-btn"), Attr.HandlerImpl("click", () =>() => setPopular(title, author))], [Doc.Element("span", [Attr.Create("class", "pop-title")], [Doc.TextNode(title)]), Doc.Element("span", [Attr.Create("class", "pop-author")], [Doc.TextNode(author)])]);
  }, popularBooks()))])]), Doc.BindView((searched) =>!searched?Doc.Element("div", [], []):Doc.Element("div", [Attr.Create("class", "results-section")], [Doc.BindView((t) => Doc.Element("div", [Attr.Create("class", "results-header")], [Doc.Element("p", [Attr.Create("class", "section-title")], [Doc.TextNode("\ud83d\udcc4 Results for: \""+t+"\"")]), Doc.Element("p", [Attr.Create("class", "results-hint")], [Doc.TextNode("\u2705 Best source opened automatically \u2014 use cards below as backup")])]), titleVar().View), Doc.Element("div", [Attr.Create("class", "results-grid")], [Doc.BindView((sources) => Doc.Concat(map((s) => Doc.Element("div", [Attr.Create("class", s.IsBest?"result-card best-card":"result-card")], [Doc.Element("div", [Attr.Create("class", "result-top")], [Doc.Element("span", [Attr.Create("class", "result-icon")], [Doc.TextNode(s.Icon)]), Doc.Element("div", [Attr.Create("class", "result-info")], [Doc.Element("strong", [], [Doc.TextNode(s.Name)]), Doc.Element("p", [Attr.Create("class", "result-desc")], [Doc.TextNode(s.Description)])])]), Doc.Element("a", [Attr.Create("href", s.Url), Attr.Create("target", "_blank"), Attr.Create("rel", "noopener noreferrer"), Attr.Create("class", s.IsBest?"open-btn best-btn":"open-btn")], [Doc.TextNode(s.IsBest?"\u2b50 Open Best Source \u2192":"\ud83d\udd17 Open \u2192")])]), sources)), resultsVar().View)])]), searchedVar().View), Doc.BindView((history) => history.$==0?Doc.Element("div", [], []):Doc.Element("div", [Attr.Create("class", "history-section")], [Doc.Element("p", [Attr.Create("class", "section-title")], [Doc.TextNode("\ud83d\udd50 Recent Searches")]), Doc.Element("div", [Attr.Create("class", "history-list")], [Doc.Concat(map((h) => Doc.Element("button", [Attr.Create("class", "history-btn"), Attr.HandlerImpl("click", () =>() => setPopular(h.Title, h.Author))], [Doc.Element("span", [], [Doc.TextNode(h.Title)]), Doc.Element("span", [Attr.Create("class", "history-author")], [Doc.TextNode(h.Author)])]), history))])]), historyVar().View), Doc.Element("div", [Attr.Create("class", "footer")], [Doc.Element("p", [Attr.Create("class", "footer-dim")], [Doc.TextNode("\ud83d\udcda BookFinder \u2014 Built with F# & WebSharper")]), Doc.Element("p", [], [Doc.Element("span", [Attr.Create("class", "footer-dim")], [Doc.TextNode("University of Dunaújváros  \u2022  ")]), Doc.Element("span", [Attr.Create("class", "footer-name")], [Doc.TextNode("Fahad Muhammad")]), Doc.Element("span", [Attr.Create("class", "footer-dim")], [Doc.TextNode("  \u2022  VEL6D3")])])])]);
  LoadLocalTemplates("");
  Doc.RunById("main", _1);
}
function titleVar(){
...
function doSearch(){
  ...
  const author=Trim(authorVar().Get());
  if(title=="")msgVar().Set("\u26a0\ufe0f Please enter a book title!");
  else {
    msgVar().Set("");
    loadingVar().Set(true);
    searchedVar().Set(false);
    setTimeout(() => {
      const sources=buildSources(title, author);
      resultsVar().Set(sources);
      loadingVar().Set(false);
      searchedVar().Set(true);
      const best=tryFind((s) => s.IsBest, sources);
      if(best==null){ }
      else globalThis.open(best.$0.Url, "_blank");
      historyVar().Set(ofSeq(truncate(8, distinctBy((h) => h.Title, FSharpList.Cons(New_1(title, author==""?"Unknown":author), historyVar().Get())))));
    }, 1800);
  }
}
function msgVar(){
...
function loadingVar(){
  return _c.loadingVar;
}
function popularBooks(){
  return _c.popularBooks;
}
function setPopular(title, author){
  titleVar().Set(title);
  authorVar().Set(author);
  doSearch();
}
function searchedVar(){
  return _c.searchedVar;
}
function resultsVar(){
  return _c.resultsVar;
}
function historyVar(){
  return _c.historyVar;
}
function buildSources(title, author){
  const enc=(s) => encodeURIComponent(s);
  const q=enc(title+" "+author);
  return ofArray([New("Internet Archive", "\ud83d\udcda", "\u2705 Best source \u2014 Free digital library, millions of books", "https://archive.org/search?query="+q+"&and[]=mediatype%3A%22texts%22", true), New("Library Genesis", "\ud83d\udcd6", "Largest free book database", "https://libgen.is/search.php?req="+q+"&res=25&view=simple", false), New("PDF Drive", "\ud83d\udcc4", "80 million+ free PDF books", "https://www.pdfdrive.com/search?q="+q, false), New("Z-Library", "\ud83d\udcd7", "World's largest e-book library", "https://z-lib.id/s/"+q, false), New("Open Library", "\ud83c\udf10", "Open access to millions of books", "https://openlibrary.org/search?q="+q, false), New("Google PDF Search", "\ud83d\udd0d", "Search Google for PDF files directly", "https://www.google.com/search?q=filetype%3Apdf+"+enc(title)+"+"+enc(author), false), New("Bing PDF Search", "\ud83d\udd0e", "Bing search filtered for PDF documents", "https://www.bing.com/search?q=filetype%3Apdf+"+q, false), New("DuckDuckGo PDF", "\ud83e\udd86", "Privacy-friendly PDF search", "https://duckduckgo.com/?q=filetype%3Apdf+"+q, false)]);
}
...
function New(Name, Icon, Description, Url, IsBest){
  return{
    Name:Name, 
    Icon:Icon, 
...
let _c=Lazy((_i) => class $StartupCode_Client {
  ...
  static popularBooks;
  static {
    this.popularBooks=ofArray([["Clean Code", "Robert Martin"], ["The Great Gatsby", "F. Scott Fitzgerald"], ["Atomic Habits", "James Clear"], ["1984", "George Orwell"], ["Harry Potter", "J.K. Rowling"], ["The Pragmatic Programmer", "David Thomas"], ["Deep Work", "Cal Newport"], ["Thinking Fast and Slow", "Daniel Kahneman"]]);
    this.titleVar=_c_1.Create_1("");
    this.authorVar=_c_1.Create_1("");
    this.resultsVar=_c_1.Create_1(FSharpList.Empty);
    this.historyVar=_c_1.Create_1(FSharpList.Empty);
    this.searchedVar=_c_1.Create_1(false);
    this.loadingVar=_c_1.Create_1(false);
    this.msgVar=_c_1.Create_1("");
  }
});
