...
function Main(){
  const tabBtn=(id, label) => Doc.BindView((current) => Doc.Element("button", [Attr.Create("class", current==id?"tab active":"tab"), Attr.HandlerImpl("click", () =>() => activeTab().Set(id))], [Doc.TextNode(label)]), activeTab().View);
  const _1=Doc.Element("div", [Attr.Create("class", "app")], [Doc.Element("div", [Attr.Create("class", "header")], [Doc.Element("span", [Attr.Create("class", "label-left")], [Doc.TextNode("VEL6D3")]), Doc.Element("span", [Attr.Create("class", "label-right")], [Doc.TextNode("Fahad Muhammad")]), Doc.Element("h1", [], [Doc.TextNode("StudentLife Manager")]), Doc.Element("p", [], [Doc.TextNode("Your complete university life, in one place")])]), Doc.Element("div", [Attr.Create("class", "tabs")], [tabBtn("exams", "Exams"), tabBtn("assignments", "Assignments"), tabBtn("budget", "Budget"), tabBtn("habits", "Habits"), tabBtn("timer", "Timer")]), Doc.Element("div", [Attr.Create("class", "content")], [Doc.BindView((tab) => tab=="exams"?examModule():tab=="assignments"?assignmentModule():tab=="budget"?budgetModule():tab=="habits"?habitModule():tab=="timer"?timerModule():examModule(), activeTab().View)])]);
  LoadLocalTemplates("");
  Doc.RunById("main", _1);
}
function activeTab(){
...
function examModule(){
  const subjectVar=_c_1.Create_1("");
  const dateVar=_c_1.Create_1("");
  const priorityVar=_c_1.Create_1("Normal");
  const msgVar=_c_1.Create_1("");
  return Doc.Element("div", [Attr.Create("class", "module-container")], [Doc.Element("h2", [], [Doc.TextNode("Exam Planner")]), Doc.Element("div", [Attr.Create("class", "form-group")], [Doc.Input([Attr.Create("placeholder", "Subject name")], subjectVar), Doc.Input([Attr.Create("placeholder", "Exam date (e.g. 2026-05-10)")], dateVar), Doc.Element("div", [Attr.Create("class", "priority-btns")], [Doc.Element("button", [Attr.Create("class", "btn-urgent"), Attr.HandlerImpl("click", () =>() => priorityVar.Set("Urgent"))], [Doc.TextNode("Urgent")]), Doc.Element("button", [Attr.Create("class", "btn-normal"), Attr.HandlerImpl("click", () =>() => priorityVar.Set("Normal"))], [Doc.TextNode("Normal")]), Doc.Element("button", [Attr.Create("class", "btn-safe"), Attr.HandlerImpl("click", () =>() => priorityVar.Set("Safe"))], [Doc.TextNode("Safe")])]), Doc.Element("button", [Attr.Create("class", "btn-primary"), Attr.HandlerImpl("click", () =>() => {
    if(subjectVar.Get()==""||dateVar.Get()=="")return msgVar.Set("Please fill all fields!");
    else {
      const exam=New(getNextId(), subjectVar.Get(), dateVar.Get(), parsePriority(priorityVar.Get()));
      exams().Set(append(exams().Get(), ofArray([exam])));
      subjectVar.Set("");
      dateVar.Set("");
      return msgVar.Set("Exam added!");
    }
  })], [Doc.TextNode("Add Exam")])]), Doc.Element("p", [Attr.Create("class", "msg")], [Doc.TextView(msgVar.View)]), Doc.Element("div", [Attr.Create("class", "list-container")], [Doc.BindView((examList) => examList.$==0?Doc.Element("p", [Attr.Create("class", "empty-msg")], [Doc.TextNode("No exams added yet.")]):Doc.Concat(map((e) => Doc.Element("div", [Attr.Create("class", "list-item")], [Doc.Element("div", [Attr.Create("class", "item-info")], [Doc.Element("strong", [], [Doc.TextNode(e.Subject)]), Doc.Element("span", [Attr.Create("class", "badge")], [Doc.TextNode(priorityText(e.Priority))]), Doc.Element("span", [Attr.Create("class", "date")], [Doc.TextNode(e.Date)])]), Doc.Element("button", [Attr.Create("class", "btn-danger"), Attr.HandlerImpl("click", () =>() => {
    const id=e.Id;
    return exams().Set(filter((e_1) => e_1.Id!==id, exams().Get()));
  })], [Doc.TextNode("Remove")])]), examList)), exams().View)])]);
}
function assignmentModule(){
  const titleVar=_c_1.Create_1("");
  const subjectVar=_c_1.Create_1("");
  const deadlineVar=_c_1.Create_1("");
  const msgVar=_c_1.Create_1("");
  return Doc.Element("div", [Attr.Create("class", "module-container")], [Doc.Element("h2", [], [Doc.TextNode("Assignment Tracker")]), Doc.Element("div", [Attr.Create("class", "form-group")], [Doc.Input([Attr.Create("placeholder", "Assignment title")], titleVar), Doc.Input([Attr.Create("placeholder", "Subject")], subjectVar), Doc.Input([Attr.Create("placeholder", "Deadline (e.g. 2026-05-01)")], deadlineVar), Doc.Element("button", [Attr.Create("class", "btn-primary"), Attr.HandlerImpl("click", () =>() => {
    if(titleVar.Get()==""||subjectVar.Get()==""||deadlineVar.Get()=="")return msgVar.Set("Please fill all fields!");
    else {
      const a=New_1(getNextId(), titleVar.Get(), subjectVar.Get(), deadlineVar.Get(), false);
      assignments().Set(append(assignments().Get(), ofArray([a])));
      titleVar.Set("");
      subjectVar.Set("");
      deadlineVar.Set("");
      return msgVar.Set("Assignment added!");
    }
  })], [Doc.TextNode("Add Assignment")])]), Doc.Element("p", [Attr.Create("class", "msg")], [Doc.TextView(msgVar.View)]), Doc.Element("div", [Attr.Create("class", "list-container")], [Doc.BindView((aList) => aList.$==0?Doc.Element("p", [Attr.Create("class", "empty-msg")], [Doc.TextNode("No assignments added yet.")]):Doc.Concat(map((a) => Doc.Element("div", [Attr.Create("class", a.Done?"list-item done":"list-item")], [Doc.Element("div", [Attr.Create("class", "item-info")], [Doc.Element("strong", [], [Doc.TextNode(a.Title)]), Doc.Element("span", [Attr.Create("class", "badge")], [Doc.TextNode(a.Subject)]), Doc.Element("span", [Attr.Create("class", "date")], [Doc.TextNode(a.Deadline)])]), Doc.Element("div", [Attr.Create("class", "btn-group")], [Doc.Element("button", [Attr.Create("class", "btn-success"), Attr.HandlerImpl("click", () =>() => {
    const id=a.Id;
    return assignments().Set(map((a_1) => a_1.Id===id?New_1(a_1.Id, a_1.Title, a_1.Subject, a_1.Deadline, !a_1.Done):a_1, assignments().Get()));
  })], [Doc.TextNode(a.Done?"Undo":"Done")]), Doc.Element("button", [Attr.Create("class", "btn-danger"), Attr.HandlerImpl("click", () =>() => {
    const id=a.Id;
    return assignments().Set(filter((a_1) => a_1.Id!==id, assignments().Get()));
  })], [Doc.TextNode("Remove")])])]), aList)), assignments().View)])]);
}
function budgetModule(){
  const descVar=_c_1.Create_1("");
  const amountVar=_c_1.Create_1("");
  const catVar=_c_1.Create_1("Food");
  const typeVar=_c_1.Create_1("Expense");
  const msgVar=_c_1.Create_1("");
  return Doc.Element("div", [Attr.Create("class", "module-container")], [Doc.Element("h2", [], [Doc.TextNode("Budget Tracker")]), Doc.Element("div", [Attr.Create("class", "form-group")], [Doc.Input([Attr.Create("placeholder", "Description")], descVar), Doc.Input([Attr.Create("placeholder", "Amount")], amountVar), Doc.Element("div", [Attr.Create("class", "priority-btns")], [Doc.Element("button", [Attr.Create("class", "btn-cat"), Attr.HandlerImpl("click", () =>() => catVar.Set("Food"))], [Doc.TextNode("Food")]), Doc.Element("button", [Attr.Create("class", "btn-cat"), Attr.HandlerImpl("click", () =>() => catVar.Set("Transport"))], [Doc.TextNode("Transport")]), Doc.Element("button", [Attr.Create("class", "btn-cat"), Attr.HandlerImpl("click", () =>() => catVar.Set("Books"))], [Doc.TextNode("Books")]), Doc.Element("button", [Attr.Create("class", "btn-cat"), Attr.HandlerImpl("click", () =>() => catVar.Set("Fun"))], [Doc.TextNode("Fun")]), Doc.Element("button", [Attr.Create("class", "btn-cat"), Attr.HandlerImpl("click", () =>() => catVar.Set("Other"))], [Doc.TextNode("Other")])]), Doc.Element("div", [Attr.Create("class", "priority-btns")], [Doc.Element("button", [Attr.Create("class", "btn-danger"), Attr.HandlerImpl("click", () =>() => typeVar.Set("Expense"))], [Doc.TextNode("Expense")]), Doc.Element("button", [Attr.Create("class", "btn-success"), Attr.HandlerImpl("click", () =>() => typeVar.Set("Income"))], [Doc.TextNode("Income")])]), Doc.Element("button", [Attr.Create("class", "btn-primary"), Attr.HandlerImpl("click", () =>() => {
    let o=0;
    const _1=Number(amountVar.Get());
    let _2=isNaN(_1)?false:(o=_1,true);
    const m=[_2, o];
    if(m[0]&&m[1]>0){
      const t=New_2(getNextId(), descVar.Get(), m[1], catVar.Get(), typeVar.Get()=="Income"?Income:Expense);
      transactions().Set(append(transactions().Get(), ofArray([t])));
      descVar.Set("");
      amountVar.Set("");
      return msgVar.Set("Transaction added!");
    }
    else return msgVar.Set("Enter a valid amount!");
  })], [Doc.TextNode("Add")])]), Doc.Element("p", [Attr.Create("class", "msg")], [Doc.TextView(msgVar.View)]), Doc.Element("div", [Attr.Create("class", "stats-bar")], [Doc.BindView((tList) => {
    const balance=calculateBalance(tList);
    const income=totalIncome(tList);
    const expense=totalExpense(tList);
    return Doc.Element("div", [Attr.Create("class", "stats-inner")], [Doc.Element("span", [Attr.Create("class", "stat-green")], [Doc.TextNode("Income: "+String(income))]), Doc.Element("span", [Attr.Create("class", "stat-red")], [Doc.TextNode("Expense: "+String(expense))]), Doc.Element("span", [Attr.Create("class", balance>=0?"stat-green":"stat-red")], [Doc.TextNode("Balance: "+String(balance))])]);
  }, transactions().View)]), Doc.Element("div", [Attr.Create("class", "list-container")], [Doc.BindView((tList) => tList.$==0?Doc.Element("p", [Attr.Create("class", "empty-msg")], [Doc.TextNode("No transactions yet.")]):Doc.Concat(map((t) => Doc.Element("div", [Attr.Create("class", "list-item")], [Doc.Element("div", [Attr.Create("class", "item-info")], [Doc.Element("strong", [], [Doc.TextNode(t.Description)]), Doc.Element("span", [Attr.Create("class", "badge")], [Doc.TextNode(t.Category)]), Doc.Element("span", [Attr.Create("class", t.TType.$===0?"stat-green":"stat-red")], [Doc.TextNode(String(t.Amount))])]), Doc.Element("button", [Attr.Create("class", "btn-danger"), Attr.HandlerImpl("click", () =>() => {
    const id=t.Id;
    return transactions().Set(filter((t_1) => t_1.Id!==id, transactions().Get()));
  })], [Doc.TextNode("Remove")])]), tList)), transactions().View)])]);
}
function habitModule(){
  const habitVar=_c_1.Create_1("");
  const msgVar=_c_1.Create_1("");
  return Doc.Element("div", [Attr.Create("class", "module-container")], [Doc.Element("h2", [], [Doc.TextNode("Habit Tracker")]), Doc.Element("div", [Attr.Create("class", "form-group")], [Doc.Input([Attr.Create("placeholder", "New habit (e.g. Study 2 hours)")], habitVar), Doc.Element("button", [Attr.Create("class", "btn-primary"), Attr.HandlerImpl("click", () =>() => {
    if(habitVar.Get()=="")return msgVar.Set("Enter a habit name!");
    else {
      const h=New_3(getNextId(), habitVar.Get(), false, 0);
      habits().Set(append(habits().Get(), ofArray([h])));
      habitVar.Set("");
      return msgVar.Set("Habit added!");
    }
  })], [Doc.TextNode("Add Habit")])]), Doc.Element("p", [Attr.Create("class", "msg")], [Doc.TextView(msgVar.View)]), Doc.Element("div", [Attr.Create("class", "list-container")], [Doc.BindView((hList) => hList.$==0?Doc.Element("p", [Attr.Create("class", "empty-msg")], [Doc.TextNode("No habits added yet.")]):Doc.Concat(map((h) => Doc.Element("div", [Attr.Create("class", h.Completed?"list-item done":"list-item")], [Doc.Element("div", [Attr.Create("class", "item-info")], [Doc.Element("strong", [], [Doc.TextNode(h.Name)]), Doc.Element("span", [Attr.Create("class", "badge")], [Doc.TextNode("Streak: "+String(h.Streak))])]), Doc.Element("div", [Attr.Create("class", "btn-group")], [Doc.Element("button", [Attr.Create("class", "btn-success"), Attr.HandlerImpl("click", () =>() => {
    const id=h.Id;
    return habits().Set(map((h_1) => {
      let _1;
      if(h_1.Id===id){
        if(!h_1.Completed)_1=h_1.Streak+1;
        else {
          const a=0;
          const b=h_1.Streak-1;
          _1=Compare(a, b)===1?a:b;
        }
        return New_3(h_1.Id, h_1.Name, !h_1.Completed, _1);
      }
      else return h_1;
    }, habits().Get()));
  })], [Doc.TextNode(h.Completed?"Undo":"Done")]), Doc.Element("button", [Attr.Create("class", "btn-danger"), Attr.HandlerImpl("click", () =>() => {
    const id=h.Id;
    return habits().Set(filter((h_1) => h_1.Id!==id, habits().Get()));
  })], [Doc.TextNode("Remove")])])]), hList)), habits().View)])]);
}
function timerModule(){
  return Doc.Element("div", [Attr.Create("class", "module-container")], [Doc.Element("h2", [], [Doc.TextNode("Study Timer - Pomodoro")]), Doc.Element("div", [Attr.Create("class", "timer-display")], [Doc.BindView((s) => Doc.Element("h1", [Attr.Create("class", "timer-text")], [Doc.TextNode(String(s/60>>0)+"(D2):"+String(s%60)+"(D2)")]), timerSeconds().View)]), Doc.Element("div", [Attr.Create("class", "form-group")], [Doc.Input([Attr.Create("placeholder", "What are you studying?")], timerSubject())]), Doc.Element("div", [Attr.Create("class", "btn-group")], [Doc.Element("button", [Attr.Create("class", "btn-primary"), Attr.HandlerImpl("click", () =>() => {
    if(!timerRunning().Get()){
      timerRunning().Set(true);
      function tick(){
        if(timerRunning().Get()&&timerSeconds().Get()>0)setTimeout(() => {
          timerSeconds().Set(timerSeconds().Get()-1);
          tick();
        }, 1000);
        else if(timerSeconds().Get()===0){
          timerRunning().Set(false);
          const log="Completed: "+timerSubject().Get()+" - 25 min session";
          studyLog().Set(FSharpList.Cons(log, studyLog().Get()));
          timerSeconds().Set(1500);
        }
      }
      return tick();
    }
    else return null;
  })], [Doc.TextNode("Start")]), Doc.Element("button", [Attr.Create("class", "btn-danger"), Attr.HandlerImpl("click", () =>() => timerRunning().Set(false))], [Doc.TextNode("Pause")]), Doc.Element("button", [Attr.Create("class", "btn-secondary"), Attr.HandlerImpl("click", () =>() => {
    timerRunning().Set(false);
    return timerSeconds().Set(1500);
  })], [Doc.TextNode("Reset")])]), Doc.Element("h3", [], [Doc.TextNode("Study Log")]), Doc.Element("div", [Attr.Create("class", "list-container")], [Doc.BindView((logs) => logs.$==0?Doc.Element("p", [Attr.Create("class", "empty-msg")], [Doc.TextNode("No study sessions yet.")]):Doc.Concat(map((l) => Doc.Element("p", [Attr.Create("class", "log-item")], [Doc.TextNode(l)]), logs)), studyLog().View)])]);
}
function exams(){
  return _c.exams;
}
function priorityText(p){
  return p.$==1?"Normal":p.$==2?"Safe":"Urgent";
}
function getNextId(){
  const id=nextId();
  set_nextId(nextId()+1);
...
function parsePriority(s){
  return s=="Urgent"?Urgent:s=="Safe"?Safe:Normal;
}
function assignments(){
  return _c.assignments;
}
function transactions(){
  return _c.transactions;
}
function calculateBalance(transactions_1){
  return fold((_1, _2) => _2.TType.$==1?_1-_2.Amount:_1+_2.Amount, 0, transactions_1);
}
function totalExpense(transactions_1){
  return sumBy((t) => t.Amount, filter((t) => t.TType.$===1, transactions_1));
}
function totalIncome(transactions_1){
  return sumBy((t) => t.Amount, filter((t) => t.TType.$===0, transactions_1));
}
function habits(){
  return _c.habits;
}
function timerSeconds(){
  return _c.timerSeconds;
}
function timerSubject(){
  return _c.timerSubject;
}
function studyLog(){
  return _c.studyLog;
}
function timerRunning(){
  return _c.timerRunning;
}
...
let _c=Lazy((_i) => class $StartupCode_Client {
  ...
  static {
    this.nextId=1;
    this.activeTab=_c_1.Create_1("exams");
    this.exams=_c_1.Create_1(FSharpList.Empty);
    this.assignments=_c_1.Create_1(FSharpList.Empty);
    this.transactions=_c_1.Create_1(FSharpList.Empty);
    this.habits=_c_1.Create_1(FSharpList.Empty);
    this.timerSeconds=_c_1.Create_1(1500);
    this.timerRunning=_c_1.Create_1(false);
    this.timerSubject=_c_1.Create_1("");
    this.studyLog=_c_1.Create_1(FSharpList.Empty);
  }
});
...
function New(Id, Subject, Date_1, Priority){
  return{
    Id:Id, 
    Subject:Subject, 
    Date:Date_1, 
...
function New_1(Id, Title, Subject, Deadline, Done){
  return{
    Id:Id, 
    Title:Title, 
    Subject:Subject, 
...
function New_2(Id, Description, Amount, Category, TType){
  return{
    Id:Id, 
...
let Income={$:0};
let Expense={$:1};
function New_3(Id, Name, Completed, Streak){
  return{
    Id:Id, 
    Name:Name, 
    Completed:Completed, 
